...
curl -s "https://api.openweathermap.org/data/2.5/weather?lat=$store_lat&lon=$store_lon&appid=$WEATHER_KEY&units=imperial" > $folder_path/cahe_store_weather.txt
...
figlet -w 100 -c -f Merlin1 "Weather"
echo " "
